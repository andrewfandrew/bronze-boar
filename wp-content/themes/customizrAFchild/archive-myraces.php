...
<div id="main-wrapper" class="<?php echo tc__f( 'tc_main_wrapper_classes' , 'container' ) ?>">
 ...
 <h2>Future races <small>All races </small></h2>
...
<svg width="400" height="200">
  ...
  <g filter="url(#MyFilter)">
    ...
    <text fill="#FFFFFF" stroke="black" font-size="38" font-family="Verdana" x="52" y="76">Torill</text>
  </g>
  Sorry, your browser does not support inline SVG.  
                ...
                $today = date('Ymd');
                $args= array('post_type'  => 'myraces', 'posts_per_page' => 7, 'paged' => $paged, 'meta_query' => array(
		array(
	        'key'		=> 'start_date',
	        'compare'	=> '>=',
	        'value'		=> $today,
