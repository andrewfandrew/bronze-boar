    ...
    <div class="container" role="main">
        <div class="<?php echo tc__f( 'tc_column_content_wrapper_classes' , 'row column-content-wrapper' ) ?>">
			...
			<div class="page-header">
				<h2>Race Reports <small>Torill's write ups </small></h2>
   				</div></div>
            ...
            array(
                ...
                $the_query = new WP_Query( $args ); ?>
					...
					echo '<div class="span11 offset1"><a href="' . get_permalink() . '" class="btn btn-default btn-xs" role="button">View report</a>' . '</div></div></div>';
